...
##### Data Plane
It is where the data is processed. Unless we choose to use Serverless Compute, the compute resources in the data plane run inside the business owner's own cloud account.
